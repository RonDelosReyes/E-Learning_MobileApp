...
// Admin pages
import 'package:e_learning_app/admin/a_profile_page.dart';
import 'package:e_learning_app/admin/a_user_management.dart';
...
class AdminAppDrawer extends StatelessWidget {
  ...
  List<DrawerMenuItem> _menuItems(BuildContext context) {
    return [
      DrawerMenuItem(
        title: 'Home',
        onTap: () => _navigate(context, const AdminDashBoardPage()),
      ),
      DrawerMenuItem(
        title: 'User Manager',
        onTap: () => _navigate(context, const AdminUserManagerPage()),
      ),
      DrawerMenuItem(
        title: 'System Logs',
      ...
      DrawerMenuItem(
        title: 'My Profile',
        onTap: () => _navigate(context, const AdminProfilePage()),
      ),
      DrawerMenuItem(
        title: 'Log Out',
        isLogout: true,

...
class ProfileStorageService {
  ...
  final String _bucketName = 'ProfilePictures'; // Main bucket name
  final String _folderName = 'profiles'; // Subfolder name
  ...
  /// - Uploads new image into 'profiles/' folder
  ...
  Future<String?> uploadProfileImage({
    ...
    try {
      // Generate a unique filename inside the 'profiles' folder
      final fileExt = file.path.split('.').last;
      final uniqueId = const Uuid().v4();
      final newFileName = '$_folderName/user_${userId}_$uniqueId.$fileExt';
